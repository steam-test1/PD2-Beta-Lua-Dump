...
function CoreEditor:build_menubar()
	...
	Global.frame:connect("INFO UNIT", "EVT_COMMAND_MENU_SELECTED", callback(self, self, "toggle_info"), {info_menu, "INFO UNIT"})
	...
	Global.frame:connect("USE LIGHT", "EVT_COMMAND_MENU_SELECTED", callback(self, self, "toggle_light"), {view_menu, "USE LIGHT"})
